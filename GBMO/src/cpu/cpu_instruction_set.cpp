...
void CPU::_initialize_instruction_tables()
{
    ...
    m_cb_prefix_instruction[0x80] = [this]() { _reset_bit( m_registers.b, u8( 0 ) ); return 8; };
    m_cb_prefix_instruction[0x81] = [this]() { _reset_bit( m_registers.c, u8( 0 ) ); return 8; };
    m_cb_prefix_instruction[0x82] = [this]() { _reset_bit( m_registers.d, u8( 0 ) ); return 8; };
    m_cb_prefix_instruction[0x83] = [this]() { _reset_bit( m_registers.e, u8( 0 ) ); return 8; };
    m_cb_prefix_instruction[0x84] = [this]() { _reset_bit( m_registers.h, u8( 0 ) ); return 8; };
    m_cb_prefix_instruction[0x85] = [this]() { _reset_bit( m_registers.l, u8( 0 ) ); return 8; };
    m_cb_prefix_instruction[0x86] = bind( &CPU::_reset_bit_hl, this, u8( 0 ) );
    m_cb_prefix_instruction[0x87] = [this]() { _reset_bit( m_registers.a, u8( 0 ) ); return 8; };
    m_cb_prefix_instruction[0x88] = [this]() { _reset_bit( m_registers.b, u8( 1 ) ); return 8; };
    m_cb_prefix_instruction[0x89] = [this]() { _reset_bit( m_registers.c, u8( 1 ) ); return 8; };
    m_cb_prefix_instruction[0x8A] = [this]() { _reset_bit( m_registers.d, u8( 1 ) ); return 8; };
    m_cb_prefix_instruction[0x8B] = [this]() { _reset_bit( m_registers.e, u8( 1 ) ); return 8; };
    m_cb_prefix_instruction[0x8C] = [this]() { _reset_bit( m_registers.h, u8( 1 ) ); return 8; };
    m_cb_prefix_instruction[0x8D] = [this]() { _reset_bit( m_registers.l, u8( 1 ) ); return 8; };
    m_cb_prefix_instruction[0x8E] = bind( &CPU::_reset_bit_hl, this, u8( 1 ) );
    m_cb_prefix_instruction[0x8F] = [this]() { _reset_bit( m_registers.a, u8( 1 ) ); return 8; };
    m_cb_prefix_instruction[0x90] = [this]() { _reset_bit( m_registers.b, u8( 2 ) ); return 8; };
    m_cb_prefix_instruction[0x91] = [this]() { _reset_bit( m_registers.c, u8( 2 ) ); return 8; };
    m_cb_prefix_instruction[0x92] = [this]() { _reset_bit( m_registers.d, u8( 2 ) ); return 8; };
    m_cb_prefix_instruction[0x93] = [this]() { _reset_bit( m_registers.e, u8( 2 ) ); return 8; };
    m_cb_prefix_instruction[0x94] = [this]() { _reset_bit( m_registers.h, u8( 2 ) ); return 8; };
    m_cb_prefix_instruction[0x95] = [this]() { _reset_bit( m_registers.l, u8( 2 ) ); return 8; };
    m_cb_prefix_instruction[0x96] = bind( &CPU::_reset_bit_hl, this, u8( 2 ) );
    m_cb_prefix_instruction[0x97] = [this]() { _reset_bit( m_registers.a, u8( 2 ) ); return 8; };
    m_cb_prefix_instruction[0x98] = [this]() { _reset_bit( m_registers.b, u8( 3 ) ); return 8; };
    m_cb_prefix_instruction[0x99] = [this]() { _reset_bit( m_registers.c, u8( 3 ) ); return 8; };
    m_cb_prefix_instruction[0x9A] = [this]() { _reset_bit( m_registers.d, u8( 3 ) ); return 8; };
    m_cb_prefix_instruction[0x9B] = [this]() { _reset_bit( m_registers.e, u8( 3 ) ); return 8; };
    m_cb_prefix_instruction[0x9C] = [this]() { _reset_bit( m_registers.h, u8( 3 ) ); return 8; };
    m_cb_prefix_instruction[0x9D] = [this]() { _reset_bit( m_registers.l, u8( 3 ) ); return 8; };
    m_cb_prefix_instruction[0x9E] = bind( &CPU::_reset_bit_hl, this, u8( 3 ) );
    m_cb_prefix_instruction[0x9F] = [this]() { _reset_bit( m_registers.a, u8( 3 ) ); return 8; };
    m_cb_prefix_instruction[0xA0] = [this]() { _reset_bit( m_registers.b, u8( 4 ) ); return 8; };
    m_cb_prefix_instruction[0xA1] = [this]() { _reset_bit( m_registers.c, u8( 4 ) ); return 8; };
    m_cb_prefix_instruction[0xA2] = [this]() { _reset_bit( m_registers.d, u8( 4 ) ); return 8; };
    m_cb_prefix_instruction[0xA3] = [this]() { _reset_bit( m_registers.e, u8( 4 ) ); return 8; };
    m_cb_prefix_instruction[0xA4] = [this]() { _reset_bit( m_registers.h, u8( 4 ) ); return 8; };
    m_cb_prefix_instruction[0xA5] = [this]() { _reset_bit( m_registers.l, u8( 4 ) ); return 8; };
    m_cb_prefix_instruction[0xA6] = bind( &CPU::_reset_bit_hl, this, u8( 4 ) );
    m_cb_prefix_instruction[0xA7] = [this]() { _reset_bit( m_registers.a, u8( 4 ) ); return 8; };
    m_cb_prefix_instruction[0xA8] = [this]() { _reset_bit( m_registers.b, u8( 5 ) ); return 8; };
    m_cb_prefix_instruction[0xA9] = [this]() { _reset_bit( m_registers.c, u8( 5 ) ); return 8; };
    m_cb_prefix_instruction[0xAA] = [this]() { _reset_bit( m_registers.d, u8( 5 ) ); return 8; };
    m_cb_prefix_instruction[0xAB] = [this]() { _reset_bit( m_registers.e, u8( 5 ) ); return 8; };
    m_cb_prefix_instruction[0xAC] = [this]() { _reset_bit( m_registers.h, u8( 5 ) ); return 8; };
    m_cb_prefix_instruction[0xAD] = [this]() { _reset_bit( m_registers.l, u8( 5 ) ); return 8; };
    m_cb_prefix_instruction[0xAE] = bind( &CPU::_reset_bit_hl, this, u8( 5 ) );
    m_cb_prefix_instruction[0xAF] = [this]() { _reset_bit( m_registers.a, u8( 5 ) ); return 8; };
    m_cb_prefix_instruction[0xB0] = [this]() { _reset_bit( m_registers.b, u8( 6 ) ); return 8; };
    m_cb_prefix_instruction[0xB1] = [this]() { _reset_bit( m_registers.c, u8( 6 ) ); return 8; };
    m_cb_prefix_instruction[0xB2] = [this]() { _reset_bit( m_registers.d, u8( 6 ) ); return 8; };
    m_cb_prefix_instruction[0xB3] = [this]() { _reset_bit( m_registers.e, u8( 6 ) ); return 8; };
    m_cb_prefix_instruction[0xB4] = [this]() { _reset_bit( m_registers.h, u8( 6 ) ); return 8; };
    m_cb_prefix_instruction[0xB5] = [this]() { _reset_bit( m_registers.l, u8( 6 ) ); return 8; };
    m_cb_prefix_instruction[0xB6] = bind( &CPU::_reset_bit_hl, this, u8( 6 ) );
    m_cb_prefix_instruction[0xB7] = [this]() { _reset_bit( m_registers.a, u8( 6 ) ); return 8; };
    m_cb_prefix_instruction[0xB8] = [this]() { _reset_bit( m_registers.b, u8( 7 ) ); return 8; };
    m_cb_prefix_instruction[0xB9] = [this]() { _reset_bit( m_registers.c, u8( 7 ) ); return 8; };
    m_cb_prefix_instruction[0xBA] = [this]() { _reset_bit( m_registers.d, u8( 7 ) ); return 8; };
    m_cb_prefix_instruction[0xBB] = [this]() { _reset_bit( m_registers.e, u8( 7 ) ); return 8; };
    m_cb_prefix_instruction[0xBC] = [this]() { _reset_bit( m_registers.h, u8( 7 ) ); return 8; };
    m_cb_prefix_instruction[0xBD] = [this]() { _reset_bit( m_registers.l, u8( 7 ) ); return 8; };
    m_cb_prefix_instruction[0xBE] = bind( &CPU::_reset_bit_hl, this, u8( 7 ) );
    m_cb_prefix_instruction[0xBF] = [this]() { _reset_bit( m_registers.a, u8( 7 ) ); return 8; };
    m_cb_prefix_instruction[0xC0] = [this]() { _set_bit( m_registers.b, u8( 0 ) ); return 8; };
    m_cb_prefix_instruction[0xC1] = [this]() { _set_bit( m_registers.c, u8( 0 ) ); return 8; };
    m_cb_prefix_instruction[0xC2] = [this]() { _set_bit( m_registers.d, u8( 0 ) ); return 8; };
    m_cb_prefix_instruction[0xC3] = [this]() { _set_bit( m_registers.e, u8( 0 ) ); return 8; };
    m_cb_prefix_instruction[0xC4] = [this]() { _set_bit( m_registers.h, u8( 0 ) ); return 8; };
    m_cb_prefix_instruction[0xC5] = [this]() { _set_bit( m_registers.l, u8( 0 ) ); return 8; };
    m_cb_prefix_instruction[0xC6] = bind( &CPU::_set_bit_hl, this, u8( 0 ) );
    m_cb_prefix_instruction[0xC7] = [this]() { _set_bit( m_registers.a, u8( 0 ) ); return 8; };
    m_cb_prefix_instruction[0xC8] = [this]() { _set_bit( m_registers.b, u8( 1 ) ); return 8; };
    m_cb_prefix_instruction[0xC9] = [this]() { _set_bit( m_registers.c, u8( 1 ) ); return 8; };
    m_cb_prefix_instruction[0xCA] = [this]() { _set_bit( m_registers.d, u8( 1 ) ); return 8; };
    m_cb_prefix_instruction[0xCB] = [this]() { _set_bit( m_registers.e, u8( 1 ) ); return 8; };
    m_cb_prefix_instruction[0xCC] = [this]() { _set_bit( m_registers.h, u8( 1 ) ); return 8; };
    m_cb_prefix_instruction[0xCD] = [this]() { _set_bit( m_registers.l, u8( 1 ) ); return 8; };
    m_cb_prefix_instruction[0xCE] = bind( &CPU::_set_bit_hl, this, u8( 1 ) );
    m_cb_prefix_instruction[0xCF] = [this]() { _set_bit( m_registers.a, u8( 1 ) ); return 8; };
    m_cb_prefix_instruction[0xD0] = [this]() { _set_bit( m_registers.b, u8( 2 ) ); return 8; };
    m_cb_prefix_instruction[0xD1] = [this]() { _set_bit( m_registers.c, u8( 2 ) ); return 8; };
    m_cb_prefix_instruction[0xD2] = [this]() { _set_bit( m_registers.d, u8( 2 ) ); return 8; };
    m_cb_prefix_instruction[0xD3] = [this]() { _set_bit( m_registers.e, u8( 2 ) ); return 8; };
    m_cb_prefix_instruction[0xD4] = [this]() { _set_bit( m_registers.h, u8( 2 ) ); return 8; };
    m_cb_prefix_instruction[0xD5] = [this]() { _set_bit( m_registers.l, u8( 2 ) ); return 8; };
    m_cb_prefix_instruction[0xD6] = bind( &CPU::_set_bit_hl, this, u8( 2 ) );
    m_cb_prefix_instruction[0xD7] = [this]() { _set_bit( m_registers.a, u8( 2 ) ); return 8; };
    m_cb_prefix_instruction[0xD8] = [this]() { _set_bit( m_registers.b, u8( 3 ) ); return 8; };
    m_cb_prefix_instruction[0xD9] = [this]() { _set_bit( m_registers.c, u8( 3 ) ); return 8; };
    m_cb_prefix_instruction[0xDA] = [this]() { _set_bit( m_registers.d, u8( 3 ) ); return 8; };
    m_cb_prefix_instruction[0xDB] = [this]() { _set_bit( m_registers.e, u8( 3 ) ); return 8; };
    m_cb_prefix_instruction[0xDC] = [this]() { _set_bit( m_registers.h, u8( 3 ) ); return 8; };
    m_cb_prefix_instruction[0xDD] = [this]() { _set_bit( m_registers.l, u8( 3 ) ); return 8; };
    m_cb_prefix_instruction[0xDE] = bind( &CPU::_set_bit_hl, this, u8( 3 ) );
    m_cb_prefix_instruction[0xDF] = [this]() { _set_bit( m_registers.a, u8( 3 ) ); return 8; };
    m_cb_prefix_instruction[0xE0] = [this]() { _set_bit( m_registers.b, u8( 4 ) ); return 8; };
    m_cb_prefix_instruction[0xE1] = [this]() { _set_bit( m_registers.c, u8( 4 ) ); return 8; };
    m_cb_prefix_instruction[0xE2] = [this]() { _set_bit( m_registers.d, u8( 4 ) ); return 8; };
    m_cb_prefix_instruction[0xE3] = [this]() { _set_bit( m_registers.e, u8( 4 ) ); return 8; };
    m_cb_prefix_instruction[0xE4] = [this]() { _set_bit( m_registers.h, u8( 4 ) ); return 8; };
    m_cb_prefix_instruction[0xE5] = [this]() { _set_bit( m_registers.l, u8( 4 ) ); return 8; };
    m_cb_prefix_instruction[0xE6] = bind( &CPU::_set_bit_hl, this, u8( 4 ) );
    m_cb_prefix_instruction[0xE7] = [this]() { _set_bit( m_registers.a, u8( 4 ) ); return 8; };
    m_cb_prefix_instruction[0xE8] = [this]() { _set_bit( m_registers.b, u8( 5 ) ); return 8; };
    m_cb_prefix_instruction[0xE9] = [this]() { _set_bit( m_registers.c, u8( 5 ) ); return 8; };
    m_cb_prefix_instruction[0xEA] = [this]() { _set_bit( m_registers.d, u8( 5 ) ); return 8; };
    m_cb_prefix_instruction[0xEB] = [this]() { _set_bit( m_registers.e, u8( 5 ) ); return 8; };
    m_cb_prefix_instruction[0xEC] = [this]() { _set_bit( m_registers.h, u8( 5 ) ); return 8; };
    m_cb_prefix_instruction[0xED] = [this]() { _set_bit( m_registers.l, u8( 5 ) ); return 8; };
    m_cb_prefix_instruction[0xEE] = bind( &CPU::_set_bit_hl, this, u8( 5 ) );
    m_cb_prefix_instruction[0xEF] = [this]() { _set_bit( m_registers.a, u8( 5 ) ); return 8; };
    m_cb_prefix_instruction[0xF0] = [this]() { _set_bit( m_registers.b, u8( 6 ) ); return 8; };
    m_cb_prefix_instruction[0xF1] = [this]() { _set_bit( m_registers.c, u8( 6 ) ); return 8; };
    m_cb_prefix_instruction[0xF2] = [this]() { _set_bit( m_registers.d, u8( 6 ) ); return 8; };
    m_cb_prefix_instruction[0xF3] = [this]() { _set_bit( m_registers.e, u8( 6 ) ); return 8; };
    m_cb_prefix_instruction[0xF4] = [this]() { _set_bit( m_registers.h, u8( 6 ) ); return 8; };
    m_cb_prefix_instruction[0xF5] = [this]() { _set_bit( m_registers.l, u8( 6 ) ); return 8; };
    m_cb_prefix_instruction[0xF6] = bind( &CPU::_set_bit_hl, this, u8( 6 ) );
    m_cb_prefix_instruction[0xF7] = [this]() { _set_bit( m_registers.a, u8( 6 ) ); return 8; };
    m_cb_prefix_instruction[0xF8] = [this]() { _set_bit( m_registers.b, u8( 7 ) ); return 8; };
    m_cb_prefix_instruction[0xF9] = [this]() { _set_bit( m_registers.c, u8( 7 ) ); return 8; };
    m_cb_prefix_instruction[0xFA] = [this]() { _set_bit( m_registers.d, u8( 7 ) ); return 8; };
    m_cb_prefix_instruction[0xFB] = [this]() { _set_bit( m_registers.e, u8( 7 ) ); return 8; };
    m_cb_prefix_instruction[0xFC] = [this]() { _set_bit( m_registers.h, u8( 7 ) ); return 8; };
    m_cb_prefix_instruction[0xFD] = [this]() { _set_bit( m_registers.l, u8( 7 ) ); return 8; };
    m_cb_prefix_instruction[0xFE] = bind( &CPU::_set_bit_hl, this, u8( 7 ) );
    m_cb_prefix_instruction[0xFF] = [this]() { _set_bit( m_registers.a, u8( 7 ) ); return 8; };
}
