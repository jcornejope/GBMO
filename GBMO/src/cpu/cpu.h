...
private:
    ...
    void _process_carry_flag_8( u16 const value, bool const is_addition );
    void _process_carry_flag_16( u32 const value, bool const is_addition );
    void _process_half_carry_flag_8( u8 const value, u8 const carry, bool const is_addition );
    void _process_half_carry_flag_8( u8 const reg, u8 const value, u8 const carry, bool const is_addition );
    void _process_half_carry_flag_16( u16 const reg, u16 const value );
